...
public class Main {
            ...
            if (menu == 1) {
                ...
                if (reservation == null) {
                    ...
                    if (reservation == null) {
                        ...
                        System.out.println("취소된 병원" + reservation.hospital.name);
                        reservation = null;
                    }
                }
             else if (menu == 0) {
    ...
    public static void showUser(User user) {
        ...
        System.out.println("전화번호: " + user.phone);
    }

    public static void showHospitals(Hospital[] hospitels) {
